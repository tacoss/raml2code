var customAdapter, generator, parseResource, utilSchemas, _;
...
generator.parser = function(data) {
  var first, k, methodParse, model, options, parsed, resource, resourceGroup, result, schemas, v, version, _i, _len, _ref;
  parsed = [];
