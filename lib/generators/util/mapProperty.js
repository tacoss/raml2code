...
util.mapProperty = function(property, name, annotation, mapping, refMap) {
  var auxType, data, innerClass, keyRef, keyRefData, primitiveType, _ref, _ref1;
  data = {};
  data.property = {};
  data.property.name = name;
  data.property.required = (_ref = property.required) != null ? _ref : {
    "true": false
  };
  data.property.size = [];
  ...
  switch (property.type) {
    ...
    case 'object':
      ...
      break;
    default:
      data.property.type = (_ref1 = mapping[property.type]) != null ? _ref1 : property.type;
  }
