...
describe('should generate a Pojo', function () {
  ...
  var catDTO = function(done){
    test(generator, done, {package: 'org.gex', enableAnnotations: false}, undefined , "v1/Cat.groovy")
  };
  var catDTOJSR303 = function(done){
    test(generator, done, {package: 'org.gex'}, undefined, "v1/Cat.groovy")
  };
  var widgetDTOInlineRef = function(done){
    test(generator, done, {package: 'org.gex'}, undefined, "v1/Widget.groovy")
  };

  var widgetDTOInlinePropertyRef = function(done){
    test(generator, done, {package: 'org.gex'}, undefined, "v1/WidgetInlineProperty.groovy")
  };
